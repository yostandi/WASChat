...
public class BubbleDrawableBuilder {
  ...
  public Drawable create(Context context) {
    ...
    final int              radius = context.getResources().getDimensionPixelSize(R.dimen.conversation_item_corner_radius);
    ...
    if (!hasShadow) {
      ...
      final int              distance = context.getResources().getDimensionPixelSize(R.dimen.conversation_item_drop_shadow_dist);
